...
import lotus from '../assets/loginbg.jpg'
    ...
    <div className={`h-screen ${styles.loginbg}`}>
      <div className="py-6 sm:py-8 lg:py-10">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <form className={`mx-auto max-w-lg rounded-lg border-2 ${styles.glass}`}>
          <h2 className="text-center text-2xl font-bold text-gray-800 md:mb-2 lg:text-3xl">Login</h2>
            ...
            <div className="flex flex-col gap-4 p-4 md:p-8">
              ...
              <div className="relative flex items-center justify-center">
                <span className="relative  px-4 py-2 text-l text-black">Log in with social</span>
              </div>
